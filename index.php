...
<body>
    <div class="container">
        <div class="mt-5 pt-5 text-center">
            <img src="img/arun.jpg" class="rounded-circle" style="width: 170px;height: 170px">
            <br>
            <br>
            <h1>Arunprakasan AKV</h1>
            <h3>Full stack Developer</h3>
            <br>
            <h6>&#147;Everything is Right When You Believe That is Right.&#148;</h6>
        </div>
        <br>
        <div id="final_content">
            <div class='test col-sm-9 container-fluid' style='animation: moveToTop .9s ease both;'>
                <h1 class='text-center'>Hai...............</h1><hr/>
...
<script type="text/javascript">
    ...
    smartlook('init', 'c42f626578a5a2f474f82d67d271e6194f785fb1');
</script>
</html>
